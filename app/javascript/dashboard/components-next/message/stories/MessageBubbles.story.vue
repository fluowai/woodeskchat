...
const getMessage = overrides => {
  ...
  return {
    id: 5272,
    content: 'Hey, how are ya, I had a few questions about Woodesk?',
    inboxId: 475,
    conversationId: 43,
    messageType: 0,
    contentType: 'text',
...
const email = computed(() =>
  getMessage({
    ...
    attachments: [
      ...
      getAttachment('file', 'https://woodesk.dev/invoice.pdf'),
      getAttachment('file', 'https://woodesk.dev/logs.txt'),
      getAttachment('file', 'https://woodesk.dev/contacts.xls'),
      getAttachment('file', 'https://woodesk.dev/customers.csv'),
      getAttachment('file', 'https://woodesk.dev/warehousing-policy.docx'),
      getAttachment('file', 'https://woodesk.dev/pitch-deck.ppt'),
      getAttachment('file', 'https://woodesk.dev/all-files.tar'),
      getAttachment(
        'audio',
