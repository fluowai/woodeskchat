...
const { t } = useI18n();
const { currentAccount, accountId, isOnWoodeskCloud, updateAccount } =
  useAccount();
...
const showPaywall = computed(() => !props.isEnabled && isOnWoodeskCloud.value);
const i18nKey = computed(() =>
  isOnWoodeskCloud.value ? 'PAYWALL' : 'ENTERPRISE_PAYWALL'
);
...
<template>
  ...
  >
    ...
    <BasePaywallModal
      ...
      :i18n-key="i18nKey"
      :is-on-woodesk-cloud="isOnWoodeskCloud"
