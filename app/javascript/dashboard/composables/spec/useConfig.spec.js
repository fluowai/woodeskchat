...
describe('useConfig', () => {
  const originalWoodeskConfig = window.woodeskConfig;
  ...
  afterEach(() => {
    window.woodeskConfig = originalWoodeskConfig;
  });
  ...
  it('handles undefined window.woodeskConfig', () => {
    window.woodeskConfig = undefined;
    const config = useConfig();
