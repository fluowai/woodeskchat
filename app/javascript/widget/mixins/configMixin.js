export default {
  computed: {
    ...
    hasAConnectedAgentBot() {
      return !!window.woodeskWebChannel.hasAConnectedAgentBot;
    },
    inboxAvatarUrl() {
      return window.woodeskWebChannel.avatarUrl;
    },
    channelConfig() {
      return window.woodeskWebChannel;
    },
    ...
    preChatFormEnabled() {
      return window.woodeskWebChannel.preChatFormEnabled;
    },
    preChatFormOptions() {
      let preChatMessage = '';
      const options = window.woodeskWebChannel.preChatFormOptions || {};
