...
describe('useAvailability', () => {
  const originalWindow = window.woodeskWebChannel;
  ...
  afterEach(() => {
    window.woodeskWebChannel = originalWindow;
  });
  ...
  describe('config changes', () => {
    it('should react to window.woodeskWebChannel changes', () => {
