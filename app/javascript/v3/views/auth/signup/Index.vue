...
const isAWoodeskInstance = computed(
  () => globalConfig.value.installationName === 'Woodesk'
);

onBeforeMount(() => {
  isLoading.value = isAWoodeskInstance.value;
});
...
<template>
  ...
  >
    ...
    <div
      ...
      :class="{ 'w-auto xl:w-full': isAWoodeskInstance }"
    >
