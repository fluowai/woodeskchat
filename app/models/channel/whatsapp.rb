...
class Channel::Whatsapp < ApplicationRecord
  ...
  encrypts :business_management_token if Woodesk.encryption_configured?
  ...
  def template_access_token
    return provider_config['api_key'] unless WoodeskApp.woodesk_cloud? && provider_config['source'] == 'embedded_signup'
