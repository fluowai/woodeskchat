...
class Message < ApplicationRecord
  searchkick callbacks: false if WoodeskApp.advanced_search_allowed?
  ...
  def should_index?
    return false unless WoodeskApp.advanced_search_allowed?
    ...
    return false if WoodeskApp.woodesk_cloud? && !account.feature_enabled?('advanced_search_indexing')
  ...
  def execute_after_create_commit_callbacks
    ...
    # Custom Slash Command Interceptor for BR adaptations (e.g. /pix)
    Messages::SlashCommandService.new(message: self).perform
  end
