module Redis::RedisKeys
  ...
  WOODESK_INSTALLATION_ONBOARDING = 'WOODESK_INSTALLATION_ONBOARDING'.freeze
  WOODESK_INSTALLATION_CONFIG_RESET_WARNING = 'WOODESK_CONFIG_RESET_WARNING'.freeze
  LATEST_WOODESK_VERSION = 'LATEST_WOODESK_VERSION'.freeze
