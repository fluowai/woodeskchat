# Woodesk E2E Testing - Documentation

Complete guide for writing and maintaining E2E tests for Woodesk.

---

## Overview

End-to-end testing suite for Woodesk built with Playwright and TypeScript using the Component Object Model (COM) pattern.
...
TEST_USER_EMAIL=admin@woodesk.com
...
- Verify `.env` credentials match Woodesk
...
**Timeout errors:**
- Ensure Woodesk is running at `BASE_URL`
