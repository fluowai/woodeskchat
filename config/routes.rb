Rails.application.routes.draw do
        ...
        scope module: :accounts do
          ...
          resources :conversations, only: [:index, :create, :show, :update, :destroy] do
            ...
            member do
              ...
              get :attachments
              get :inbox_assistant
              get :reporting_events if WoodeskApp.enterprise?
            end
          end
          ...
          resources :contacts, only: [:index, :show, :update, :create, :destroy] do
            ...
            scope module: :contacts do
              ...
              post :call, on: :member, to: 'calls#create' if WoodeskApp.enterprise?
            end
          end
          ...
          resources :csat_survey_responses, only: [:index] do
            ...
            member do
              patch :update if WoodeskApp.enterprise?
            end
          end
          ...
          resources :reporting_events, only: [:index] if WoodeskApp.enterprise?

          if WoodeskApp.enterprise?
  ...
  namespace :webhooks do
    post 'payments/asaas', to: 'payments#asaas'
    post 'payments/mercadopago', to: 'payments#mercadopago'
    
    post 'telegram/:account_id/:inbox_id' => 'telegram#process_payload'
    post 'line/:account_id/:inbox_id' => 'line#process_payload'
    post 'whatsapp/:account_id/:inbox_id' => 'whatsapp#process_payload'
  end
